...
public class RDKitSubstructFilterNodeFactory extends NodeFactory<RDKitSubstructFilterNodeModel> 
    ...
    private static final String NODE_NAME = "RDKit Substructure Filter";
    ...
    private static final String FULL_DESCRIPTION = """
            Applies a substructure filter to an input RDKit Mol column. The substructure query is given as a
            single SMARTS pattern. Molecules that match the pattern appear in the first output table, molecules
            that don't match appear in the second output table.
            """;
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, RDKitSubstructFilterNodeParameters.class);
    }
