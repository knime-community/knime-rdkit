...
final class RDKitHighlightingNodeParameters implements NodeParameters {
    ...
    static final class Highlightings implements NodeParameters {
        ...
        @Widget(title = "Color",
            description = "Hex color for highlighting (e.g. #FF0000). Leave blank to use the RDKit default color.")
        Color m_color;
    ...
    static final class NewColumnNameAutoGuessProvider extends RDKitResultColumnNameAutoGuessProvider {
		...
		protected NewColumnNameAutoGuessProvider() {
			super(InputColumnNameRef.class, NewColumnNameRef.class, "(Highlighting)");
		}
