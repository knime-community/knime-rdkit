...
final class RDKitRemoveHsNodeParameters implements NodeParameters {
    ...
    static final class InputColumnDefaultProvider extends RDKitMoleculeColumnAutoGuessProvider {
        protected InputColumnDefaultProvider() {
    ...
    static final class NewColumnNameProvider extends RDKitResultColumnNameAutoGuessProvider {
		...
		protected NewColumnNameProvider() {
			super(InputColumnRef.class, NewColumnNameRef.class, "(Removed Hs)");
		}
    ...
    static final class RemoveSourceColumnRef implements ParameterReference<Boolean> {
	}
