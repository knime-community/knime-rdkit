...
public class RDKitAddHsNodeFactory 
     ...
     * {@inheritDoc}
     */
    private static final String NODE_NAME = "RDKit Add Hs";
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("Output table with RDKit molecules with added Hs", """
                Output table with RDKit molecules with added Hs.
                """)
    );
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, RDKitAddHsNodeParameters.class);
    }
