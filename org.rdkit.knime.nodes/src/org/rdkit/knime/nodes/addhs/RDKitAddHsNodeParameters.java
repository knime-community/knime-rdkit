...
final class RDKitAddHsNodeParameters implements NodeParameters {
    ...
    @Persist(configKey = RDKitAddHsNodeModel.CFG_INPUT_COLUMN)
    ...
    @Persist(configKey = RDKitAddHsNodeModel.CFG_NEW_COLUMN_NAME)
    ...
    static final class NewColumnNameProvider extends RDKitResultColumnNameAutoGuessProvider {
		...
		protected NewColumnNameProvider() {
			super(InputColumnRef.class, NewColumnNameRef.class, "(Added Hs)");
		}
    ...
    @Persist(configKey = RDKitAddHsNodeModel.CFG_REMOVE_SOURCE_COLUMNS)
