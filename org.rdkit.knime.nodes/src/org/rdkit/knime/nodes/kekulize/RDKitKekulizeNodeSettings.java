...
/**
 * Settings for the RDKit Kekulize node using the webui framework.
 * 
 * @author Marc Lehner, KNIME GmbH, Zurich, Switzerland
 */
public final class RDKitKekulizeNodeSettings implements DefaultNodeSettings {
    ...
    @Widget(title = "New Column Name",
            description = "Name for the newly created column with kekulized molecules.")
