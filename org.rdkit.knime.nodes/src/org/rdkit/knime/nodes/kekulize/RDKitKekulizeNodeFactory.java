...
public class RDKitKekulizeNodeFactory 
        extends NodeFactory<RDKitKekulizeNodeModel> implements NodeDialogFactory {
    ...
    private static final String NODE_NAME = "RDKit Kekulizer";
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("Output table with kekulized RDKit molecules", """
                Output table with kekulized RDKit molecules.
                """)
    );
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, RDKitKekulizeNodeParameters.class);
    }
