...
/**
 * Node parameters for RDKit From IUPAC.
 *
 * @author Jannik Semperowitsch, KNIME GmbH, Konstanz, Germany
 * @author AI Migration Pipeline v1.2
 */
@LoadDefaultsForAbsentFields
final class RDKitIUPACToRDKitNodeParameters implements NodeParameters {

    @Widget(title = "IUPAC name column", description = "The input column with IUPAC names.")
    ...
    @Persist(configKey = RDKitIUPACToRDKitNodeModel.CFG_INPUT_COLUMN)
    ...
    @Persist(configKey = RDKitIUPACToRDKitNodeModel.CFG_NEW_COLUMN_NAME)
