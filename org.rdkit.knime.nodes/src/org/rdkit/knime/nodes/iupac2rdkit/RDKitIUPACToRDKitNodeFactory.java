 ...
 */
public class RDKitIUPACToRDKitNodeFactory extends NodeFactory<RDKitIUPACToRDKitNodeModel> implements NodeDialogFactory {
    ...
    private static final String NODE_NAME = "RDKit From IUPAC";
    private static final String NODE_ICON = "default.png";
    private static final String SHORT_DESCRIPTION = """
            Converts IUPAC names to RDKit molecules.
            """;
    private static final String FULL_DESCRIPTION = """
            Converts IUPAC names to RDKit molecules. Internally, the conversion is done to SMILES first using
                the OPSIN library, and afterwards an RDKit molecule is created from the SMILES value.
            """;
    private static final List<PortDescription> INPUT_PORTS = List.of(
            fixedPort("Input table with IUPAC names", """
                Table containing IUPAC names.
                """)
    );
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            fixedPort("Successful conversions", """
                Successfully converted RDKit molecules.
                """),
            fixedPort("Failed conversions", """
                All input rows where the IUPAC name could not be converted successfully.
                """)
    );
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, RDKitIUPACToRDKitNodeParameters.class);
    }
    ...
    public NodeDescription createNodeDescription() {
        return DefaultNodeDescriptionUtil.createNodeDescription( //
            ...
            FULL_DESCRIPTION, //
            List.of(), //
            RDKitIUPACToRDKitNodeParameters.class, //
            null, //
