...
public class RDKitChemicalTransformationNodeFactory 
        extends NodeFactory<RDKitChemicalTransformationNodeModel> implements NodeDialogFactory {
    ...
    public NodeDialogPane createNodeDialogPane() {
    	return NodeDialogManager.createLegacyFlowVariableNodeDialog((NodeDialog) new RDKitChemicalTransformationNodeDialog());
    }
    
    @Override
    public NodeDialog createNodeDialog() {
        // Create the dialog using the DefaultNodeDialog with our new settings class.
        return new DefaultNodeDialog(SettingsType.MODEL, RDKitChemicalTransformationNodeSettings.class);
    }    
}
