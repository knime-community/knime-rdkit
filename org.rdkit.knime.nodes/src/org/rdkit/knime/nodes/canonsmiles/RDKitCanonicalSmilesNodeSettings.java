...
/**
 * Settings for the RDKit Canonical Smiles node using the webui framework.
 * 
 * @author Marc Lehner, KNIME GmbH, Zurich, Switzerland
 */
public class RDKitCanonicalSmilesNodeSettings implements DefaultNodeSettings {
		...
		@Widget(title="New Column Name",description="Name for the newly created column with generated coordinates.")
        String m_newColumnName;
        
        @Persist(configKey = "remove_source_columns")
        @Widget(title="Remove Source Column",description="If checked, the original source column is removed from the output table.")
