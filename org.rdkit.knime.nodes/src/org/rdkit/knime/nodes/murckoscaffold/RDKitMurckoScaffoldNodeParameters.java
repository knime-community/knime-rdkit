...
/**
 * Node parameters for RDKit Find Murcko Scaffolds.
 *
 * @author Magnus Gohm, KNIME GmbH, Konstanz, Germany
 * @author AI Migration Pipeline v1.2
 */
@LoadDefaultsForAbsentFields
final class RDKitMurckoScaffoldNodeParameters implements NodeParameters {

    @Widget(title = "RDKit mol column", description = """
    		The column containing RDKit molecules for which the Murcko scaffold will be computed.
    		""")
    ...
    @Widget(title = "New column name", description = """
    		Name of the new column appended to the output table containing the Murcko scaffold.
    		""")
    ...
    @Widget(title = "Create frameworks", description = """
    		If checked, generic Murcko frameworks are generated (all atoms replaced by carbon, all bonds replaced by 
    		single bonds) instead of standard Murcko scaffolds.
    		""")
    @Persist(configKey = "do_frameworks")
    boolean m_doFrameworks;
    ...
    static final class NewColumnNameAutoGuessProvider extends RDKitResultColumnNameAutoGuessProvider {
        ...
        NewColumnNameAutoGuessProvider() {
            super(InputColumnNameRef.class, NewColumnNameRef.class, "(Murcko)");
        }
