 ...
 */
public class DescriptorCalculationNodeFactory extends NodeFactory<DescriptorCalculationNodeModel>  implements NodeDialogFactory {
	...
	public NodeDialogPane createNodeDialogPane() {
		return NodeDialogManager.createLegacyFlowVariableNodeDialog((NodeDialog) new DescriptorCalculationNodeDialog());
	}
	
	@Override
    public NodeDialog createNodeDialog() {
        // Create the dialog using the DefaultNodeDialog with our new settings class.
        return new DefaultNodeDialog(SettingsType.MODEL, DescriptorCalculationNodeSettings.class);
	}
}
